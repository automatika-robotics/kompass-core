#include "utils/collision_check_fcl.h"
...
void CollisionCheckerFCL::resetOctreeResolution(const double resolution) {
...
void CollisionCheckerFCL::generateBoxesFromOctomap(
...
void CollisionCheckerFCL::updateOctreePtr() {
...
void CollisionCheckerFCL::updateState(const Path::State current_state) {
...
void CollisionCheckerFCL::updateState(const double x, const double y,
                                   const double yaw) {
...
void CollisionCheckerFCL::updateScan(const std::vector<double> &ranges,
                                  const std::vector<double> &angles) {
  convertLaserScanToOctomap(ranges, angles, robotHeight_ / 2);
}

void CollisionCheckerFCL::updatePointCloud(
    const pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud) {
  convertPointCloudToOctomap(cloud);
}

void CollisionCheckerFCL::updatePointCloud(const std::vector<Path::Point> &cloud) {
  convertPointCloudToOctomap(cloud);
}

void CollisionCheckerFCL::convertPointCloudToOctomap(
    const pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud) {
...
void CollisionCheckerFCL::convertLaserScanToOctomap(
...
bool CollisionCheckerFCL::checkCollisionsOctree() {
...
float CollisionCheckerFCL::getMinDistance() {
...
float CollisionCheckerFCL::getMinDistance(const std::vector<double> &ranges,
...
bool CollisionCheckerFCL::checkCollisions(
    const pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud) {
  convertPointCloudToOctomap(cloud);
  return checkCollisionsOctree();
}

bool CollisionCheckerFCL::checkCollisions(const std::vector<double> &ranges,
                                       double angle_min, double angle_increment,
                                       double height) {
  convertLaserScanToOctomap(ranges, angle_min, angle_increment, height);
  return checkCollisionsOctree();
...
bool CollisionCheckerFCL::checkCollisions() { return checkCollisionsOctree(); }

bool CollisionCheckerFCL::checkCollisions(const Path::State current_state) {
